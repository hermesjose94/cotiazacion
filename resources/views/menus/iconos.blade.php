      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="fa-icons">
            <section id="new">
              <h4 class="page-header">66 Nuevos Iconos en 4.4</h4>
            ...
            <section id="web-application">
              <h4 class="page-header">Iconos Web</h4>
            ...
            <section id="hand">
              <h4 class="page-header">Iconos de Manos</h4>
            ...
            <section id="transportation">
              <h4 class="page-header">Iconos de Transporte</h4>
            ...
            <section id="gender">
              <h4 class="page-header">Iconos Genero</h4>
            ...
            <section id="file-type">
              <h2 class="page-header">Iconos de Archivos</h2>
            ...
            <section id="spinner">
              <h2 class="page-header">Iconos Spinner</h2>
            ...
            <section id="form-control">
              <h4 class="page-header">Iconos de Form Control</h4>
            ...
            <section id="payment">
              <h4 class="page-header">Iconos de pago</h4>
            ...
            <section id="chart">
              <h4 class="page-header">Iconos de Graficas</h4>
            ...
            <section id="currency">
              <h4 class="page-header">Iconos de Monedas</h4>
            ...
            <section id="text-editor">
              <h4 class="page-header">Iconos de edicion de texto</h4>
            ...
            <section id="directional">
              <h4 class="page-header">Iconos de dirección</h4>
            ...
            <section id="video-player">
              <h4 class="page-header">Iconos de Video</h4>
            ...
            <section id="brand">
              <h4 class="page-header">Icons de marca</h4>

              <div class="alert alert-info">
                <ul class="margin-bottom-none padding-left-lg">
                  <li>Todos los iconos de marca son marcas comerciales de sus respectivos propietarios.</li>
                </ul>
              </div>
              <div class="row fontawesome-icon-list">
                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-500px"></i> fa fa-500px</div>
            ...
            <section id="medical">
              <h4 class="page-header">Iconos de Medicina</h4>
